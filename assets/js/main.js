(function ($) {
	...
	$(document).ready(function() {
		...
		$('.open_menu_btn').on('click', function () {
			$('.menu-popup-wrapper ').addClass('open-menu')
		});
		$('.close_menu_btn').on('click', function () {
			$('.menu-popup-wrapper ').removeClass('open-menu')
		});
		
		// $('.menu-popup-wrapper').on('click', function(e){
		// 	e.stopPropagation();
	 	// });

		 $('.menu-popup-wrapper').on('click', function(event) {
            if ($(event.target).hasClass('menu-popup-inner')) {
                return;
            }
